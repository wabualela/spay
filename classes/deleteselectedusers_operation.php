...
/**
 * A bulk operation for the spay enrolment plugin to delete selected users enrolments.
 *
 * @package enrol_spay
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_spay_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_spay');
    }
     ...
     * @return enrol_spay_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_spay');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_spay');

        return new enrol_spay_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/spay:unenrol", $manager->get_context())) {
            return false;
        }
