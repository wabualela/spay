@enrol @enrol_spay
Feature: Users can auto-enrol themspay in courses where spay enrolment is allowed
  ...
  @javascript
  Scenario: SPAY Sudani Payment-enrolment enabled as guest
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add "SPAY Sudani Payment enrolment" enrolment method with:
  ...
  Scenario: SPAY Sudani Payment-enrolment enabled
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "SPAY Sudani Payment enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
    And I log out
  ...
  Scenario: SPAY Sudani Payment-enrolment enabled requiring an enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "SPAY Sudani Payment enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  Scenario: SPAY Sudani Payment-enrolment disabled
    Given I log in as "student1"
    When I am on "Course 1" course homepage
    Then I should see "You can not enrol yourspay in this course"

  Scenario: SPAY Sudani Payment-enrolment enabled requiring a group enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "SPAY Sudani Payment enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Edit a spay-enrolled user's enrolment from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "SPAY Sudani Payment enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Unenrol a spay-enrolled student from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "SPAY Sudani Payment enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
